...
<p align="left">
  ...
  <img 
src="https://img.shields.io/badge/language-Python_3-blue.svg?style=flat-square" alt="Python 3">
...
src="https://img.shields.io/badge/license-MPL_2.0-orange.svg?style=flat-square" alt="License MPL 2.0">
  ...
  <img src="https://img.shields.io/badge/By-OctaNon-bleu.svg?style=flat-square" alt="OctaNon">
</p>
...
$$M_{i,j} = \text{viewAsInt32}\left( \text{bigEndianUint32}(I_{i,j,0..3}) \right)$$
...
$${nacc}_k \leftarrow \left( {nacc}_k + \text{viewAsUint32}(F_k) \right) \pmod{2^{32}}$$
...
$${diff}_k = \text{viewAsInt32}\left( {nacc}_k - {oacc}_k \right)$$
